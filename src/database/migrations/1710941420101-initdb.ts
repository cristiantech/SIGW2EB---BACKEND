...
export class Initdb1710941420101 implements MigrationInterface {
    name = 'Initdb1710941420101'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "package" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "trackingNumber" character varying NOT NULL, "source" character varying NOT NULL, "state" character varying NOT NULL, "address" character varying NOT NULL, "latitude" character varying, "longitude" character varying, "userId" integer, CONSTRAINT "PK_308364c66df656295bc4ec467c2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "notification" ("id" SERIAL NOT NULL, "content" character varying NOT NULL, "isRead" boolean NOT NULL DEFAULT false, "userId" integer, CONSTRAINT "PK_705b6c7cdf9b2c2ff7ac7872cb7" PRIMARY KEY ("id"))`);
